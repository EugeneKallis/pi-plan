...
const PLAN_SYSTEM_PROMPT = [
	...
	"Format each question so the user can copy-paste their answer:",
	"",
	...
	"  3. Type your own",
	"",
	"After the user answers, move to the next question (if any).",
	"Do NOT list multiple questions at once — one at a time, wait for the answer.",
	"# /PLAN MODE",
].join("\n");
